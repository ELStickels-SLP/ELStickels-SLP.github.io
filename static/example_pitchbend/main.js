...
async function start() {
    ...
    const micInput = await webaudioManager.getUserMediaForAudioAsync({
    }); 

    console.log({micInput})
      const source = webaudioManager.audioContext.createMediaStreamSource(micInput);
    ...
    source.connect(webaudioManager.audioContext.destination)
